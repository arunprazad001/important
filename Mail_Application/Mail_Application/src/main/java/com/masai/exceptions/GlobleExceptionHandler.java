...
public class GlobleExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> myEmployeeException(UserException e,WebRequest req) throws IOException {
	...
	public ResponseEntity<MyErrorDetails> myEmployeeException(MailException e,WebRequest req) throws IOException {
	...
	public ResponseEntity<MyErrorDetails> myEmployeeException(LoginException e,WebRequest req) throws IOException {
